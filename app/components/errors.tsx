...
//       />
//       <div className="border-lg mx-5vw max-h-75vh relative my-16 overflow-y-auto rounded-lg bg-red-500 p-12 text-primary">
//         <H2>{error.message}</H2>
//         <div>
//           {frames.map((frame) => (
//             <div
    ...
    <>
      ...
      <main className="relative">
        ...
        <div className="flex h-screen w-full items-center justify-center">
          <div className="border-4  border-emerald-300 p-12">
            <span className="text-3xl text-white">Er gaat iets fout!</span>
          </div>
        </div>
